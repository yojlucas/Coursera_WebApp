...
//*============VIEWALLfactory=============================*/
.factory('viewallFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
...
//*============Sellfactory=============================*/
.factory('sellFactory', ['$resource', 'baseURL', function($resource, baseURL) {
    
        return $resource(baseURL + "posting/:id", null, {
            'update': {
                method: 'PUT'
            }
        });
...
.factory('commentFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
        ...
        return $resource(baseURL + "items/:id/comments/:commentId", {id:"@Id", commentId: "@CommentId"}, {
            'update': {
                method: 'PUT'
            }
        });
